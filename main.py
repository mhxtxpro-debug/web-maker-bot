...
GEMINI_API_KEY = "AQ.Ab8RN6JvhTbw3akHjd_Ot04QMrzu1PcttXH6_Rm8M414cjqv-w"
...
def generate_website(message):
    ...
    try:
        full_prompt = f"Create a modern single-file HTML website with CSS and JS for: {user_prompt}. Provide ONLY source code. No explanations, no backticks."
        ...
        bot.send_message(chat_id, math_bold("ERROR! PLEASE TRY AGAIN."))

if __name__ == "__main__":
    keep_alive() # Start the dummy server
